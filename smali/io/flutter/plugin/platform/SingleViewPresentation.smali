...
.field private rootView:Lio/flutter/plugin/platform/s;

.field private startFocused:Z

.field private final state:Lio/flutter/plugin/platform/v;

.field private viewId:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/v;Landroid/view/View$OnFocusChangeListener;Z)V
    .locals 2
    ...
    .line 17
    invoke-direct {v0, p1, v1}, Lio/flutter/plugin/platform/t;-><init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodManager;)V
    ...
    .line 21
    iput-object p4, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/v;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/g;Lio/flutter/plugin/platform/a;ILandroid/view/View$OnFocusChangeListener;)V
    ...
    .line 11
    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/v;

    .line 12
    iput-object p3, p1, Lio/flutter/plugin/platform/v;->a:Lio/flutter/plugin/platform/g;
...
# virtual methods
.method public detachState()Lio/flutter/plugin/platform/v;
    .locals 1
    ...
    .line 8
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->rootView:Lio/flutter/plugin/platform/s;
    ...
    .line 15
    :cond_1
    iget-object v0, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/v;
...
.method public getView()Lio/flutter/plugin/platform/g;
    ...
    .line 2
    .line 3
    iget-object v0, v0, Lio/flutter/plugin/platform/v;->a:Lio/flutter/plugin/platform/g;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 16
    .line 17
    iget-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/v;

    .line 18
    .line 19
    iget-object v0, p1, Lio/flutter/plugin/platform/v;->c:Lio/flutter/plugin/platform/r;
    ...
    .line 29
    invoke-direct {v0, v1}, Lio/flutter/plugin/platform/r;-><init>(Landroid/content/Context;)V

    .line 30
    .line 31
    .line 32
    iput-object v0, p1, Lio/flutter/plugin/platform/v;->c:Lio/flutter/plugin/platform/r;
    ...
    .line 35
    .line 36
    iget-object p1, p1, Lio/flutter/plugin/platform/v;->b:Lio/flutter/plugin/platform/C;
    ...
    .line 55
    .line 56
    iget-object v2, v0, Lio/flutter/plugin/platform/v;->c:Lio/flutter/plugin/platform/r;

    .line 57
    .line 58
    invoke-direct {v1, p1, v2}, Lio/flutter/plugin/platform/C;-><init>(Landroid/view/WindowManager;Lio/flutter/plugin/platform/r;)V

    .line 59
    .line 60
    .line 61
    iput-object v1, v0, Lio/flutter/plugin/platform/v;->b:Lio/flutter/plugin/platform/C;
    ...
    .line 80
    iget-object v1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/v;

    .line 81
    .line 82
    iget-object v1, v1, Lio/flutter/plugin/platform/v;->b:Lio/flutter/plugin/platform/C;
    ...
    .line 85
    .line 86
    invoke-direct {p1, v0, v1, v2}, Lio/flutter/plugin/platform/u;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/C;Landroid/content/Context;)V
    ...
    .line 153
    .line 154
    invoke-direct {p1, v1, v2, v0}, Lio/flutter/plugin/platform/s;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/a;LX/f;)V

    .line 155
    .line 156
    .line 157
    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->rootView:Lio/flutter/plugin/platform/s;
    ...
    .line 163
    .line 164
    iget-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->rootView:Lio/flutter/plugin/platform/s;
    ...
    .line 167
    .line 168
    iget-object v1, v1, Lio/flutter/plugin/platform/v;->c:Lio/flutter/plugin/platform/r;
